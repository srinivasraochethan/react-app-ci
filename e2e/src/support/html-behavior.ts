...
export const getElementValue = async (
    ...
    // this method does not wait for the element to pass actionability checks and therefore leads to flaky tests @Todo
    ...
    //     return el?.value; // type any is bad, I need to figure out @Todo
    // });
    return value;
};
...
export const getElementTextWithinPage = async (
    ...
    const textOnPageElement = await pages[pageIndex].textContent(elementIdentifier);
    return textOnPageElement;
};
